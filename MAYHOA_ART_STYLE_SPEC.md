...
- Outline color: dark chromatic, not pure black
- Preferred colors:
  - dark olive
  - dark moss
  - dark bark brown
...
- Do not hang or decorate them randomly and meaninglessly
...
Every generation prompt for mayhoa should implicitly or explicitly include:
...
From now on, unless otherwise specified, every asset for mayhoa uses this directive by default:
